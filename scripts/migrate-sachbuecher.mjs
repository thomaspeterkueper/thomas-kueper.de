...
// ANPASSEN, falls deine Seiten woanders liegen:
const PAGES_DIR = path.join(ROOT, 'src', 'pages', 'sachbuecher');
const OUT_DIR = path.join(ROOT, 'src', 'content', 'sachbuecher');
...
function yaml(front, slug) {
  ...
  push('cover', `/assets/sachbuecher/${slug}/cover.jpg`);
  lines.push(`tags: ["Sachbuch"]`);
